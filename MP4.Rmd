...
summary(or_billed_rdv)
exp(cbind(OR=coef(or_billed_rdv), confint(or_billed_rdv)))
...
gg <- ggplot(big_table, aes(x = p.value, y = focus_var, color = sig)) +
  geom_point()

## using dev version of plotly
## devtools::install_github("ropensci/ plotly")
int_plot <- ggplotly(gg)
int_plot <- style(int_plot, hoverinfo = 'text', text = c("Female directors have 3.43x higher odds of being associated with on-screen media rated for sexual violence than male directors, out of all movies rated for violence.",  "Female actresses do not have significantly greater odds of being billed highly (<5) in on-screen media rated for rape or domestic violence than male actors.", "Female directors do not have significantly greater odds of being associated with on-screen media rated for domestic violence, out of movies rated for sexual violence.", "Female directors/producers do not have significantly greater odds of being associated with on-screen media rated for domestic violence, out of media rated for sexual violence.", "Insert gender_r blurb", "Female directors/producers do not have significantly greater odds of being associated with on-screen media rated for domestic violence or rape, out of media rated for violence.",   "Female actresses have significantly greater odds of being associated with on-screen media rated for domestic violence than male actors, out of media rated for violence."))
int_plot
```
